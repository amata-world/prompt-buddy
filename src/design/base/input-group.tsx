...
import { Button } from "@design/base/button";
import { Input } from "@design/base/input";
import { Textarea } from "@design/base/textarea";
...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: required for shadcn
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: click delegates focus to input, no keyboard equivalent needed
    // biome-ignore lint/a11y/useSemanticElements: div with role="group" used for addon grouping
    <div
      role="group"
